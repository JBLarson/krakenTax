...
extractDict = {
	'btcUsd': extractBtcUsd, 'btcEur': extractBtcEur,
	'ethUsd': extractEthUsd, 'EthEur': extractEthEur,
	'nanoUsd': extractNanoUsd,
	'AdaUsd': extractAdaUsd

}
print(extractDict['btcUsd'][1])
...
try:
	...
	print("\nSuccess Creating Crypto Json for: " + str(dtRn))
